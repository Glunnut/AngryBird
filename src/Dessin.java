...
public class Dessin extends JPanel implements KeyListener {
	...
	public void paint(Graphics g) {
		...
		/*
		 * g.drawOval(50, 100, 50, 50); g.setColor(Color.RED); g.fillOval(50,
		 * 100, 50, 50); g.setColor(Color.YELLOW); g.fillArc(100, 105, 50, 50,
		 * 160, 30); g.setColor(Color.BLACK); g.drawOval(70, 110, 20, 10);
		 * g.setColor(Color.WHITE); g.fillOval(70, 110, 20, 10);
		 * g.setColor(Color.BLACK); g.fillOval(75, 110, 10, 10);
		 */
	}
}
